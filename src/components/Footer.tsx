        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="https://w.app/ieiv5u" className="text-gray-400 hover:text-white transition-colors">Segunda via de boleto</a></li>
              <li><a href="https://w.app/ieiv5u" className="text-gray-400 hover:text-white transition-colors">Quitações de dívidas</a></li>
              <li><a href="https://w.app/ieiv5u" className="text-gray-400 hover:text-white transition-colors">Negociações</a></li>
              <li><a href="https://w.app/ieiv5u" className="text-gray-400 hover:text-white transition-colors">Ligação nova</a></li>
              <li><a href="https://w.app/ieiv5u" className="text-gray-400 hover:text-white transition-colors">Religação</a></li>
            </ul>
          </div>
